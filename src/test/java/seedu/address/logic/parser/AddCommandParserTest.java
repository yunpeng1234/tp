...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + GRADE_DESC_BOB + INSTITUTION_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + GRADE_DESC_AMY + GRADE_DESC_BOB + INSTITUTION_DESC_BOB
                        + GRADUATION_YEARMONTH_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));

        // multiple institutions - last institution accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_AMY
                        + ADDRESS_DESC_BOB + GRADE_DESC_BOB + INSTITUTION_DESC_AMY + INSTITUTION_DESC_BOB
                        + GRADUATION_YEARMONTH_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));

        // multiple graduation_year_month - last graduation_year_month accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + GRADE_DESC_BOB + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_AMY
                        + GRADUATION_YEARMONTH_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + GRADE_DESC_BOB + INSTITUTION_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + GRADE_DESC_AMY + INSTITUTION_DESC_AMY + GRADUATION_YEARMONTH_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GRADE_DESC_BOB
                + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + VALID_EMAIL_BOB + ADDRESS_DESC_BOB + GRADE_DESC_BOB
                + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB, expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + VALID_ADDRESS_BOB + GRADE_DESC_BOB
                + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB, expectedMessage);

        // missing grade prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + VALID_GRADE_BOB
                + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB, expectedMessage);

        // missing institution prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GRADE_DESC_BOB
                + VALID_INSTITUTION_BOB + GRADUATION_YEARMONTH_DESC_BOB, expectedMessage);

        // missing graduation_year_month prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GRADE_DESC_BOB
                + INSTITUTION_DESC_BOB + VALID_GRADUATION_YEARMONTH_BOB, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB
                + VALID_EMAIL_BOB + VALID_ADDRESS_BOB + VALID_GRADE_BOB
                + VALID_INSTITUTION_BOB + VALID_GRADUATION_YEARMONTH_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GRADE_DESC_BOB + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB + TAG_DESC_HUSBAND
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + GRADE_DESC_BOB + GRADE_DESC_BOB + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GRADE_DESC_BOB + INVALID_INSTITUTION_DESC + GRADUATION_YEARMONTH_DESC_BOB
                + TAG_DESC_FRIEND, Institution.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GRADE_DESC_BOB + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB + INVALID_TAG_DESC
                + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);

        // invalid grade
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_GRADE_DESC + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB + TAG_DESC_HUSBAND
                + VALID_TAG_FRIEND, Grade.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + GRADE_DESC_BOB + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GRADE_DESC_BOB + INSTITUTION_DESC_BOB + GRADUATION_YEARMONTH_DESC_BOB
