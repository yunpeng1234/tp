...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withGrade("4.50").withInstitution("NUS")
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withGrade("4.70").withInstitution("NTU").withEmail("heinz@example.com").withAddress("wall street").build();
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withGrade("4.40").withInstitution("SUSS").withEmail("anna@example.com").withAddress("4th street").build();
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withGrade("4.30").withInstitution("NUS").withEmail("hans@example.com").withAddress("chicago ave").build();


    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND)
            .withGrade(VALID_GRADE_AMY).withInstitution(VALID_INSTITUTION_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .withGrade(VALID_GRADE_BOB).withInstitution(VALID_INSTITUTION_BOB).build();
