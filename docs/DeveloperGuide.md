...
| `* * *`  | user                                       | update a applicant application         | change entries accordingly                                             |
...
**Use case: Add a applicant application**
...
**Use case: Delete a applicant application**
...
**Use case: Update a applicant application**
