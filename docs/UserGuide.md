...
* `add n/Alex Yeoh p/98765432 e/johnd@example.com g/4.50 i/NTU c/CS y/06/2025 j/Software Engineer a/SCHEDULED s/Python s/Java`<br> 
  adds a new applicant with the specified information.
